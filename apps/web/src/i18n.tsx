...
const ja: Record<string, string> = {
  ...
  Graph: "グラフ",
  "Loading Relation View": "Relation View を読み込み中",
  "Resource Relation Graph": "リソース関係グラフ",
  ...
  "Reset zoom": "拡大率をリセット",
  Reset: "リセット",
  "Reset Layout": "配置をリセット",
  Relations: "関係",
  hidden: "非表示",
  "Selected Resource": "選択中のリソース",
  "Select Resource": "リソースを選択",
  "Select a Resource to inspect Relations.":
    "リソースを選択すると関係を確認できます。",
  "Suggested Resources": "候補リソース",
  Name: "名前",
  ID: "ID",
  Degree: "接続数",
  "Outgoing Relations": "出ていく関係",
  "Incoming Relations": "入ってくる関係",
  "No outgoing Relations.": "出ていく関係はありません。",
  "No incoming Relations.": "入ってくる関係はありません。",
  "Focus Relations": "関係に集中",
  "Relation View": "関係表示",
