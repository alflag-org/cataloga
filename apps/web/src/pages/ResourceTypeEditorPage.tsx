                ...
                <tr key={`${f.name}-${i}`}>
                  <td className="px-3 py-2">
                    <TextInput
                      value={f.name}
                      onChange={(e) =>
                        upsertField(i, { ...f, name: e.target.value })
                      }
                    />
                  </td>
                  <td className="px-3 py-2">
                    <TextInput
                      value={f.label}
                      onChange={(e) =>
                        upsertField(i, { ...f, label: e.target.value })
                      }
                    />
                  </td>
                  <td className="px-3 py-2">
                  ...
                  <td className="px-3 py-2">
                    <ActionButton tone="danger" onClick={() => removeField(i)}>
                      Remove
                    </ActionButton>
                  </td>
                </tr>
      ...
      <DataCard title="Required and list columns">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <label className="block text-sm font-medium text-gray-700">
            ...
            <TextInput
              value={value.required_fields.join(",")}
              onChange={(e) =>
                setValue({
                  ...value,
          ...
          <label className="block text-sm font-medium text-gray-700">
            ...
            <TextInput
              value={value.list_columns.join(",")}
              onChange={(e) =>
                setValue({
                  ...value,
                  list_columns: e.target.value.split(",").map((s) => s.trim()),
                })
              }
            />
          </label>
