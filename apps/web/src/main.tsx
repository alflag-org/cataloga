    ...
    <BrowserRouter>
      <Routes>
        <Route element={<Layout />}>
          ...
          <Route path="/resources/:type/:id/edit" element={<ResourceEditPage />} />
          ...
          <Route path="/resource-types/:type" element={<RedirectResourceTypeToResources />} />
          <Route path="/resource-types/:type/new" element={<RedirectResourceTypeNewToResourcesNew />} />
          <Route path="/resource-types/:type/:id" element={<RedirectResourceTypeDetailToResourcesDetail />} />
          <Route path="/resource-types/:type/:id/edit" element={<RedirectResourceTypeEditToResourcesEdit />} />
